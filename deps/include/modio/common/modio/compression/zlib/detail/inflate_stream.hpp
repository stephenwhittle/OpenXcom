...
#include "modio/compression/zlib/detail/bitstream.hpp"
#include "modio/compression/zlib/detail/ranges.hpp"
#include "modio/compression/zlib/detail/window.hpp"
#if 0
#include "modio/compression/core/detail/type_traits.hpp>
...
protected:
    ...
    BOOST_BEAST_DECL void
    doWrite(z_params& zs, Flush flush, Modio::ErrorCode& ec);
...
private:
    ...
    */
    ...
    BOOST_BEAST_DECL void
    inflate_fast(ranges& r, Modio::ErrorCode& ec);
...
#include "modio/compression/zlib/detail/inflate_stream.ipp"
