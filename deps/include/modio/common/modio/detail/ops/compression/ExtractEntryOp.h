...
namespace Modio
{
	...
	namespace Detail
	{
		class ExtractEntryOp : public Modio::Detail::BaseOperation<ExtractEntryOp>
		{
		...
		public:
			ExtractEntryOp(std::shared_ptr<ArchiveFileImplementation> ArchiveFileImpl,
						 ArchiveFileImplementation::ArchiveEntry EntryToExtract,
						 Modio::filesystem::path RootDirectoryToExtractTo,
						 Modio::Optional<std::weak_ptr<Modio::ModProgressInfo>> ProgressInfo)
			{
			...
			ExtractEntryOp(ExtractEntryOp&& Other)
