...
#include "modio/detail/ops/ModioDownloadLogo.h"
...
namespace Modio
{
	namespace Detail
	{
		...
		public:
			GetModMediaLogo(Modio::GameID GameID, Modio::ApiKey ApiKey, Modio::ModID ModId, Modio::LogoSize LogoSize)
				: GameID(GameID),
				  ApiKey(ApiKey),
				  ModId(ModId),
				  LogoSize(LogoSize)
